...
namespace Magrathea
{
    ...
    public class Scalar<T> : QueryBase, IScalar<T>
    {
        ...
        public T Execute(DbContext context)
        {
            Context = context;
    ...
    public class Scalar<TSelection, TProjection> : QueryBase, IScalar<TProjection> where TSelection : class
    {
        ...
        /// </returns>
        public virtual TProjection Execute(DbContext context)
        {
        ...
        /// <returns></returns>
        public string OutputQuery(DbContext context)
        {
        ...
        private TProjection PrepareQuery(DbContext context)
        {
            Context = context;
